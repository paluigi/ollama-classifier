...
Local usage:
    ...
    Then connect:
        backend = VLLMBackend(model="meta-llama/Llama-3.2-3B-Instruct", base_url="http://localhost:8000")

Remote usage:
    backend = VLLMBackend(model="your-model", base_url="https://your-vllm-server.com/v1")
"""
...
class VLLMBackend(LLMBackend):
    ...
    def chat(
        ...
        *,
        ...
        """Perform a synchronous chat completion via vLLM."""
    ...
    async def achat(
        ...
        *,
        ...
        """Perform an asynchronous chat completion via vLLM."""
        url = f"{self._base_url}/chat/completions"
        body = self._build_body(
            messages,
            temperature=temperature,
